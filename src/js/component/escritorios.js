	...
	<div className="container">
		...
		<div className="row text-center">
			<div className="col md-4">
				<div className="card">
					<img className="card-img-top" src="imagenes/escritorio/escritorioTapia.jpg" alt="Card image cap" />
					<div className="card-body">
						<h5 className="card-title">Escritorio Tapia</h5>
						<p> Precio $95.000</p>
						<a
							href="#"
			...
			<div className="col md-4">
				<div className="card">
					<img className="card-img-top" src="imagenes/escritorio/upitre2.jpg" alt="Card image cap" />
					<div className="card-body">
						<h5 className="card-title">Upitre </h5>
						<p> Precio $65.000</p>
						<a
							href="#"
							className="btn btn-dark
			...
			<div className="col md-4">
				<div className="card">
					<img className="card-img-top" src="imagenes/escritorio/upitrePack.jpg" alt="Card image cap" />
					<div className="card-body">
						<h5 className="card-title">Upitre Pack</h5>
						<p> Precio $90.000</p>
						<a
							href="#"
							className="btn btn-dark
